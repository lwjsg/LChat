...
{
    ui->setupUi(this);
    connect(ui->btn_zc,&QPushButton::clicked,this,&LoginDialog::signal_switch);
    ui->forget_label->SetState("normal","hover","hover","selected","selected_hover","");
...
{
    // 加载图片
    QPixmap originalPixmap(":/Icon/head_1.jpg");
    // 设置图片自动缩放
